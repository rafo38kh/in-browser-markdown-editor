...
export default function TopBar({ markdown, isMenuOpend, setIsMenuOpend }) {
  ...
  return (
    <div className="fixed top-0 w-full bg-primary-800 flex items-center justify-between pr-2">
        ...
        <div className="flex justify-center flex-shrink-0 items-center gap-4">
          {isAuth ? (
            <>
              <button
                type="button"
                // onClick={() => deleteDocument(currentMarkdown?.id)}
              ...
              <button
                type="button"
                className="bg-orange-primary hover:bg-orange-secondary p-4 rounded-lg"
                onClick={() => saveDocument(currentMarkdown?.id, markdown)}
              >
