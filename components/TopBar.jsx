...
export default function TopBar({ isMenuOpend, setIsMenuOpend }) {
  ...
  const handleUpdateTitleSubmit = (e) => {
    ...
    updateDocTitle(currentMarkdown?.id, currentTitle);
  };

  return (
    <div className="max-w-screen bg-primary-800 flex items-center justify-between pr-2">
      <div className="flex justify-center items-center gap-4">
        ...
        <div className="hidden lg:block px-6 py-4 border-r-[.0625rem] border-secondary-500 mr-2">
        ...
        {!isMenuOpend && (
          <div className="flex items-center gap-4 mr-2 md:hidden">
            ...
            >
              <label className="hidden md:block text-secondary-500 text-sm">
                Document Name
              </label>
              <input
                type="text"
                ...
                className="bg-primary-800 w-full outline-none border-b-[1px] border-transparent focus:border-white text-white"
              />
            </form>
          </div>
        )}
