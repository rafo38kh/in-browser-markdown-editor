...
export default function MarkdownPreview({
  ...
  return (
    <div className="h-screen inline-block w-full overflow-hidden">
      <ScrollSyncPane>
        <div className="mx-auto h-screen overflow-y-scroll flex items-center flex-col pt-12 md:pt-0 dark:bg-primary-1000 bg-white w-full">
          <div
            className={`fixed top-16 flex h-max w-full items-center bg-tertiary-200 p-3.5 dark:bg-primary-900  md:px-5
               ${!isMenuOpend ? "justify-between" : "justify-start gap-2"}
               ${isShow ? "md:w-full" : "md:w-1/2"}`}
          >
            <span className="uppercase text-sm tracking-widest text-secondary-500 dark:text-secondary-400 ">
              Preview
            </span>
            <button className="" type="button" onClick={toggleMarkdownPreview}>
