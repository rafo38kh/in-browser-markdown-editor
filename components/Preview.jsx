...
export default function MarkdownPreview({
  ...
  return (
    <div className="h-screen inline-block w-full overflow-hidden">
      <ScrollSyncPane>
        <div className="mx-auto h-screen overflow-y-scroll flex items-center flex-col  md:pt-0 dark:bg-primary-1000 bg-white w-full">
          <div
            className={`top-16 flex h-max w-full items-center bg-tertiary-200 p-3.5 dark:bg-primary-900  md:px-5
          ...
          >
            ...
            <button
              className="fill-icons-color hover:fill-orange-primary"
              type="button"
            ...
            <button
              type="button"
              // className="hidden"
              className="fill-icons-color hover:fill-orange-primary hidden"
              onClick={toggleMarkdownPreview}
            >
              {isShow ? (
