...
export default function SideBar() {
  ...
  return (
    // h-[calc(100vh-395px)]
    <aside className="h-screen w-64 flex-shrink-0 px-6 py-7 flex flex-col bg-primary-900 justify-between items-start m-0">
      <div>
        ...
        <div className="flex flex-col justify-center items-start gap-7 my-7">
