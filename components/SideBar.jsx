  ...
  return (
    <aside className="h-screen w-64 flex-shrink-0 px-6 py-7 lg:pt-5 flex flex-col bg-primary-900 justify-between items-start m-0">
      <div>
        ...
        <div className="flex flex-col justify-center items-start gap-7 my-7 lg:mt-0">
        ...
        {!documents ? (
          ...
          currentList?.map((doc) => (
            ...
            >
              ...
              >
                <span className="text-secondary-500 block text-xs">
                  {firebaseDateToRegular(doc?.createdAt)}
                </span>
                <span
                  className={`${
                    doc?.id === currentMarkdown?.id
                      ? "text-orange-primary"
                      : "text-white"
                  } hover:text-orange-primary text-base`}
                >
                  {doc?.title}
                </span>
              </button>
