    ...
    <div className="overflow-hidden h-[100vh] md:h-full md:w-full ">
      ...
      <ScrollSyncPane>
        <textarea
          cols="30"
          rows="10"
          className="h-full w-full resize-none bg-white dark:bg-primary-1000 p-4 pb-32 pt-12 text-sm font-normal leading-6 font-roboto-mono dark:text-secondary-400 text-primary-700 md:pt-0"
          value={markdown}
          onChange={(e) => {
